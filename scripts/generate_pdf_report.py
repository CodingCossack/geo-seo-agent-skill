...
def generate_report(data, output_path="GEO-REPORT.pdf"):
    ...
    if medium_term:
        ...
        default_medium = [
            ...
            "Optimize content blocks for AI citability (compact, self-contained passages)",
    ...
    elements.append(Paragraph(
        "This report was generated by the GEO-SEO Toolkit. "
        ...
        sample_data = {
            ...
            "findings": [
                ...
                {"severity": "medium", "title": "Content Not Optimized for Citability",
                 "description": "Many content blocks are either too thin or too diffuse to quote cleanly as stand-alone answers."},
            ],
            "quick_wins": [
            ...
            "medium_term": [
                ...
                "Optimize content blocks into compact, self-contained answer units",
